...
Figure~\ref{fig:holographic} demonstrates this analytically on the identical 12-cell ensemble used in Figure~\ref{fig:recon}.
...
\\\\
2.  \textbf{Dentate gyrus → CA3}  Strong mossy-fiber synapses impose a new random-like projection onto the highly recurrent CA3 network, collapsing the sparse code into an autoassociative attractor manifold.
\\\\
